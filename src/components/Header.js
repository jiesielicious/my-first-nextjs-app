    ...
    return (
        <header className="flex flex-wrap md:flex-row flex-col items-center  gap-y-9 gap-x-8 pb-7">
            ...
            <div className="flex-1">
                <h1 className="text-4xl md:text-4xl font-black capitalize text-violet-700 dark:text-white">
                    {name}
                </h1>
                <h3 className="mt-2 text-lg md:text-xl font-semibold md:font-bold dark:text-zinc-400">
                    {jobTitle}
                </h3>
